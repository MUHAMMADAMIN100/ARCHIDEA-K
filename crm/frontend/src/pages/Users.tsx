            ...
            >
              ...
              <div className="mt-3 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  ...
                  {/*
                    Удалять сотрудников может только владелец (решение
                    владельца). Остальным руководителям остаётся «отключить» —
                    доступ пропадает, история остаётся. Тот же запрет стоит на
                    сервере.
                  */}
                  {u.id !== user?.id && user?.isOwner && (
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        removeUser(u);
