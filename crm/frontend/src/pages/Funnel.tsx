                ...
                >
                  <div className="flex items-center justify-between gap-2">
                    ...
                    */}
                    ...
                    {/*
                      Папка архива у закрытых этапов. Заказы старше 45 дней
                      уходят с доски, чтобы «Оплачено» не разрасталось до
                      сотен карточек.

                      Показываем всегда, даже с нулём (решение владельца):
                      пока папка появлялась только при непустом архиве, было
                      непохоже, что она вообще есть — первые 45 дней её никто
                      бы не увидел.
                    */}
