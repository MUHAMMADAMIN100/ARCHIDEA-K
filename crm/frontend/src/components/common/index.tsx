...
export function DataTable<T>({
  ...
  return (
    <div className="space-y-3">
      {/*
        Сколько записей сейчас в таблице.
        Отфильтровали список — надо видеть, сколько осталось, не пересчитывая
        строки глазами и не листая страницы. Число живое: меняется вместе с
        фильтрами и поиском.
      */}
      <div className="text-sm text-navy-600">
        Найдено: <span className="font-semibold text-navy-800">{list.length}</span>
      </div>
