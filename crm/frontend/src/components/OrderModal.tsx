          ...
          {tab === 'order' && (
            <div className="animate-page-in space-y-5">
              ...
              */}
              ...
              {/* Команда */}
              {/*
                Оплаченный заказ: состав менять можно, но это уже деньги.
                Закрытый выезд и смены следуют за карточкой (решение
                владельца): добавили человека — ему начислилась смена,
                убрали — снялась. Раньше карточка это молча принимала, а
                зарплата не менялась — так у «Фархунды» Гулнамо, дописанная
                на следующий день после оплаты, осталась без смены.
              */}
              {closedOrder && (
                <p className="rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-800">
                  Заказ оплачен — изменение состава сразу меняет начисленные
                  смены: добавленному начислится, убранному снимется.
                </p>
              )}
              {/*
