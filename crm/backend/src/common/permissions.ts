...
/**
 * Управляющий — вся работа компании, включая деньги, кроме раздачи доступов.
 *
 * Это руководитель по работе: воронка и клиенты всей компании, задачи,
 * команда, выезды, услуги, чек-листы, КП, аналитика, платёжные ведомости
 * и книга «Доходы и расходы» целиком — смотреть, добавлять, править,
 * удалять операции, начислять премии (решение владельца: управляющий
 * ведёт деньги наравне с руководителем). Денежные плитки аналитики —
 * выручка, чистый доход, средний чек — открыты тем же правом.
 *
 * Единственное отличие от директора — `users:manage` и корзина: раздав
 * доступы, управляющий мог бы поднять себе роль до руководителя. Личная
 * галочка «без доступа к финансам» по-прежнему сильнее роли: ею деньги
 * можно закрыть и отдельному управляющему.
 */
